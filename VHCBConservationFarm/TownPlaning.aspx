<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TownPlaning.aspx.cs" Inherits="VHCBConservationFarm.TownPlaning" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td style="margin-left: 10px; width: 50%">
                                <span class="labelClass" style="margin-left: 10px">1. Within what zoning district(s) is the farm located?</span></td>
                            <td style="width: 50%">
                        ...
                        <tr>
                            <td style="margin-left: 10px; width: 50%">
                                <span class="labelClass" style="margin-left: 10px">2.  What are the allowed minimum lot sizes?</span></td>
                            <td style="width: 50%">
                        ...
                        <tr>
                            <td style="margin-left: 10px; width: 50%">
                                <span class="labelClass" style="margin-left: 10px">3. How many feet of public road frontage is along the area to be conserved? (Note: if property straddles a road, count frontage on both sides.)</span></td>
                            <td style="width: 50%">
                        ...
                        <tr>
                            <td style="margin-left: 10px; width: 50%">
                                <span class="labelClass" style="margin-left: 10px">4. Is the farm on a public water supply?</span></td>
                            <td style="width: 50%">
                        ...
                        <tr>
                            <td style="margin-left: 10px; width: 50%">
                                <span class="labelClass" style="margin-left: 10px">5. Is the farm on a public sewer system?</span></td>
                            <td style="width: 50%">
                        ...
                        <tr>
                            <td colspan="2" style="margin-left: 10px;">
                                <span class="labelClass" style="margin-left: 10px">9. Does the deed match the mapped acreage?</span></td>
                        ...
                        <tr>
                            <td style="margin-left: 10px; width: 80%">
                                <span class="labelClass" style="margin-left: 10px">11. To the best knowledge of the landowner, are there any deed restrictions, such as restrictive covenants or mineral rights, which encumber use of the property?</span></td>
                            <td style="width: 20%">
                        ...
                        <tr>
                            <td colspan="2" style="margin-left: 10px;">
                                <span class="labelClass" style="margin-left: 10px">12. Describe how this project is in conformance with adopted or proposed  local and regional plans and zoning.</span></td>
                        ...
                        <tr>
                            <td colspan="2" style="margin-left: 10px;">
                                <span class="labelClass" style="margin-left: 10px">14.  VHCB requires applicants to inform towns and Regional Planning Commissions in writing about proposed conservation projects prior to submitting an application to VHCB.  Please confirm to whom a letter was sent.</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" style="margin-left: 10px;">
                                <span class="labelClass" style="margin-left: 10px">15. Describe any endorsements or other indications of community support for this project, if applicable</span></td>
