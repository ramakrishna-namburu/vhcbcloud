<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Page4new.aspx.cs" Inherits="ConserveNatRec.Page4new" MaintainScrollPositionOnPostback="true" %>
            ...
            <div class="panel panel-default">
                <div id="dvEntityRole" runat="server">
                    ...
                    <table style="width: 70%">
                        ...
                        <tr>
                            <td colspan="6" style="margin-left: 10px" class="auto-style7"><strong>b. Acreage</strong>
                        ...
                        <tr>
                            ...
                            <td class="auto-style18">
                              <%--  <span class="labelClass"># of taps</span>--%>
                ...
                <table>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td style="margin-left: 10px">
                            <span class="labelClass" style="margin-left: 10px"><span>Is the property enrolled in a Current Use program?</span>
                            </span></td>
                        <td>
                    ...
                    <div class="panel panel-default ">
                        <div class="panel-heading ">
                            <table style="width: 100%;">
                                <tr>
                                    <td>
                                        <h3 class="panel-title">c. Trail Mileage</h3>
                                    </td>
                                    <td style="text-align: right">
                    ...
                    <div class="panel panel-default ">
                        <div class="panel-heading ">
                            <table style="width: 100%;">
                                <tr>
                                    <td>
                                        <h3 class="panel-title">d. Allowed Special Uses</h3>
                                    </td>
                                    <td style="text-align: right">
                    ...
                    <div class="panel panel-default" style="margin-bottom: 2px;">
                        <div class="panel-heading" style="padding: 5px 5px 1px 5px">
                            <table style="width: 100%;">
                                <tr>
                                    <td>
                                        <h3 class="panel-title">e. Project Attributes</h3>
                                    </td>
                                    <td style="text-align: right">
                    ...
                    <div class="panel panel-default" style="margin-bottom: 2px;">
                        <div class="panel-heading" style="padding: 5px 5px 1px 5px">
                            <table style="width: 100%;">
                                <tr>
                                    <td>
                                        <h3 class="panel-title">f. Type of Public Access</h3>
                                    </td>
                                    <td style="text-align: right">
                    ...
                    <div class="panel panel-default" style="margin-bottom: 2px;">
                        <div class="panel-heading" style="padding: 5px 5px 1px 5px">
                            <table style="width: 100%;">
                                <tr>
                                    <td>
                                        <h3 class="panel-title">g. Alternative Energy</h3>
                                    </td>
                                    <td style="text-align: right">
