...
namespace ConserveNatRec
{
    public partial class Login : Page
    {
        ...
        {
            IsValidUser = AccountData.CheckExternalUserLogin(ProjectNumber, UserName, Password, 40238);

        }

        private void LoadProjects()
        { 
                DataTable dt = ProjectMaintenanceData.GetProjectNumbersByLoginName(UserId.Text, 40238);
