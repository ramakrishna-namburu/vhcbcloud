...
namespace ConserveNatRec
{
    public partial class EasementTerms : System.Web.UI.Page
    {
        ...
        private void LoadProject()
        {
            if (projectNumber != "")
            {
                DataRow dr = ConserveNatRecData.GetTempConserveNatRecEasementTerm(projectNumber);
        ...
        {
            ConserveNatRecData.TempConserveNatRecEasementTerm(projectNumber, txtSubDivisionReason.Text, txtHistoricSignificance.Text, txtEasementTermsOther.Text);
