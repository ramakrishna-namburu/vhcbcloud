...
namespace ConserveNatRec
{
    public partial class FirstPage : System.Web.UI.Page
    {
        ...
        private void LoadFirstPage()
        {
            ...
            if (projectNumber != "")
            {
                DataRow drPage1tDetails = ConserveNatRecData.GetConserveNatRecPage1(projectNumber);
        ...
        private void saveData()
        {
            ...
            if (projectNumber != "")
            {
                ...
                ConserveNatRecData.ConserveNatRecPage1(projectNumber, DataUtils.GetDate(ddlBoardDate.Text), DataUtils.GetDecimal(txtConservedAcres.Text),
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterStartupScript(this.GetType(),
                   "script", Helper.GetExagoURLForConservationFarm(projectNumber, "Conservation App"));
        }
