<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Attachments.aspx.cs" Inherits="ConserveNatRec.Attachments" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
                ...
                <div id="dvEntityRole" runat="server">
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                         ...
                         <tr>
                            <td style="height: 10px"><span class="auto-style7"><strong>Required Attachments</strong></span></td>
                        </tr>
                         <tr>
                            <td style="height: 10px"></td>
                        </tr>
                        <tr>
                            <td style="height: 10px; margin-left: 50px;">&nbsp;&nbsp;&nbsp; <strong>a) Fully Executed Purchase and Sale Agreement </strong>
                            </td>
                        </tr>
                        <tr>
                            <td style="height: 10px"></td>
                        ...
                        <tr>
                            <td style="margin-left: 50px;">&nbsp;&nbsp;&nbsp; <a href="https://www.vhcb.org/sites/default/files/programs/conservation/app/VHCB%20Farm%20Application%20Budget%20-%202022.xlsx" target="_blank" runat="server" id="A1">b) Budget (please use budget form found here)</a>
                            </td>
                        </tr>
                        <tr>
                            <td style="height: 10px"></td>
                        ...
                        <tr>
                            <td style="margin-left: 50px;">&nbsp;&nbsp;&nbsp; <strong>c) Ecological Assessment Report</strong>
                            </td>
                        </tr>
                        <tr>
                            <td style="height: 10px"></td>
                        ...
                        <tr>
                            <td style="margin-left: 50px;">&nbsp;&nbsp;&nbsp;  <strong>d) Maps:</strong>
                            </td>
                        </tr>
                        <tr>
                            <td style="height: 10px"></td>
...
endangered species and/or significant natural communities, important wetlands, and  deeryards, if possible.) 
                        ...
                        <tr>
                            <td style="margin-left: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>e) Photographs</strong> (showing land and buildings. maximum 8; with captions)
                            </td>
                        </tr>
                         <tr>
                            <td style="height: 10px"></td>
                        ...
                        <tr>
                            <td style="margin-left: 50px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>f) Appraisal</strong>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="margin-left: 50px;">&nbsp;&nbsp;&nbsp; <strong>a) Cover sheet</strong> (including project name, photo, and 3-5 highlights)
                        ...
                        <tr>
                            <td style="margin-left: 50px;">&nbsp;&nbsp;&nbsp; <strong>b) Tax Parcel Map</strong>
                       ...
                       <%-- <tr>
                        ...
                        <tr>
                            <td style="margin-left: 50px;">&nbsp;&nbsp;&nbsp; <strong>c) Supplemental Narrative
                        ...
                        <tr>
                            <td style="margin-left: 50px;">&nbsp;&nbsp;&nbsp; <strong>d) Letters of support</strong> (town Selectboard, business planner, etc.) 
