...
namespace ConserveNatRec
{
    public partial class Page4new : System.Web.UI.Page
    {
        ...
        {
            DataRow drPage4tDetails = ConserveNatRecData.GetConserveNarRecPage4New(projectNumber);
            ...
            if (drPage4tDetails != null)
            {
                ...
                if (DataUtils.GetBool(drPage4tDetails["EnrolledUseValue"].ToString()))
        ...
        private void saveData()
        {
            ...
            ConserveNatRecData.ConserveNarRecPage4(projectNumber, DataUtils.GetBool(rdBtnSurfaceWaters.SelectedValue.Trim()), ddlTacticalBasin.SelectedValue.ToString(),
                ...
                DataUtils.GetDecimal(txtWetlands.Text), DataUtils.GetDecimal(txtFloodPlain.Text),

                //txtWaterQualityIssues.Text, txtWQManagepractices.Text, "", //DrainageBasin
                ...
                //txtInfrastuctureDescription.Text, DataUtils.GetBool(rdbtnLivestockExcluded.SelectedValue.Trim()),  
                //DataUtils.GetBool(rdbtnManagedTimber.SelectedValue.Trim()), "",//ForestManagementPlan
                DataUtils.GetBool(rdbtnManagedTimber.SelectedValue.Trim()),
                ...
                DataUtils.GetInt(ddlWaterShedNewSec.SelectedValue), SubWatershedNewSecInt, DataUtils.GetInt(ddlHUC12Secondary.SelectedValue), DataUtils.GetBool(rdbtnEnrolledUseValue.SelectedValue.Trim())
                );

            // BindTrailCheckBoxList();
            LogMessage("Conservation Form Data Added Successfully");

            ConserveNatRecData.ConserveNatRecPage4NewConserve(projectNumber, DataUtils.GetDecimal(txtPasture.Text), DataUtils.GetDecimal(txtHay.Text), DataUtils.GetDecimal(txtUnManaged.Text), DataUtils.GetDecimal(txtFarmResident.Text),
