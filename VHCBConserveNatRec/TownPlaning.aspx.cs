...
namespace ConserveNatRec
{
    public partial class TownPlaning : System.Web.UI.Page
    {
        ...
        private void LoadPage()
        {
            if (projectNumber != "")
            {
                DataRow dr = ConserveNatRecData.GetTempConserveNatRecTownPlaning(projectNumber);
        ...
        private void saveData()
        {
            ...
            ConserveNatRecData.TempConserveNatRecTownPlaning(projectNumber, txtZoningDistrict.Text, txtMinLotSize.Text, DataUtils.GetDecimal(txtFrontageFeet.Text), 
                DataUtils.GetBool(rdbtnPublicWater.SelectedValue), DataUtils.GetBool(rdbtnPublicSewer.SelectedValue),
                //DataUtils.GetBool(rdbtnEnrolledUseValue.SelectedValue), DataUtils.GetDecimal(txtAcresExcluded.Text), txtAcresDerived.Text, txtExcludedLand.Text, 
                txtDeedMatch.Text, 
               // DataUtils.GetBool(rdbtnSurveyRequired.SelectedValue),
