                    ...
                    <div class="panel-body" runat="server" id="dvNewUserForm">
                        <asp:Panel runat="server" ID="Panel2">
                            <table style="width: 90%">
                                ...
                                <tr>
                                    <td style="width: 22%; float: left"><span class="labelClass">Default VHCB Program </span></td>
                                    <td style="width: 65%; float: left">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 65%; float: left">
                                        <asp:CheckBox ID="cbHousing" runat="server" Text =" Housing" Checked="false" CssClass="labelClass" />
                                        <asp:CheckBox ID="cbViability" runat="server" Text ="Viability" Checked="false" CssClass="labelClass" />
                        ...
                        <asp:Panel runat="server" ID="Panel11" Width="100%" Height="300px" ScrollBars="None">
                            ...
                            <asp:GridView ID="gvUserInfo" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Default VHCB Program" SortExpression="description">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="VHCB Program" SortExpression="description">
                                        <ItemTemplate>
                                            <asp:Label ID="lblVHCBPrograms" runat="Server" Text='<%# Eval("VHCBPrograms") %>' />

                                         <%--   <asp:CheckBox ID="chkHousing" Enabled="false" runat="server" Text="H" ToolTip="Housing" Checked='<%# Eval("RowIsActive") %>' />
                                            <asp:CheckBox ID="chkConservation" Enabled="false" runat="server" Text="C" ToolTip="Conservation" Checked='<%# Eval("RowIsActive") %>' />
                                            <asp:CheckBox ID="chkViability" Enabled="false" runat="server" Text="V" ToolTip="Viability" Checked='<%# Eval("RowIsActive") %>' />
                                            <asp:CheckBox ID="chkAdmin" Enabled="false" runat="server" Text="A" ToolTip="Admin" Checked='<%# Eval("RowIsActive") %>' />
                                            <asp:CheckBox ID="chkLead" Enabled="false" runat="server" Text="L" ToolTip="Lead" Checked='<%# Eval("RowIsActive") %>' />--%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
