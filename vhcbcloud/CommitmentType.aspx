<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CommitmentType.aspx.cs" Inherits="vhcbcloud.CommitmentType" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron">
        <p class="lead">Commitment Type</p>
        <div class="container">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <p>
                        <span class="labelClass">New Commitment Type:</span>
            ...
            <span class="labelClass">Method :</span>
                        ...
                        <br />
                        <asp:LinkButton ID="btnSubmit" runat="server" class="btn btn-info" Text="Add new commitment type" TabIndex="3" OnClick="btnSubmit_Click" />
                    </p>
                </div>
                <div class="panel-body">
                    <asp:GridView ID="gvLkDescription" runat="server" AutoGenerateColumns="False" AllowSorting="true" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Source" SortExpression="Method">
                                <ItemTemplate>
                                    <asp:Label ID="lblSource" runat="Server" Text='<%# Eval("method") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
